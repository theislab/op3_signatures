...
PIPELINE_NAME="nn_retraining_with_pseudolabels_fingerprints"
...
REPS=10
OUTPUT="${BASE}/results/methods/nn_retraining_with_pseudolabels_fingerprints_fp_not_dense/predictions.h5ad"
...
sbatch -W \
    ...
    --wrap="${SBATCH_PREAMBLE} && \
        ...
        python3 -m src.methods.nn_retraining_with_pseudolabels_fingerprints.script \
            --de_train ${DE_TRAIN} \
            --id_map ${ID_MAP} \
            --layer ${LAYER} \
            --reps ${REPS} \
