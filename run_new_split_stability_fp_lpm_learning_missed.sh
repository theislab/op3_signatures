...
#   data_lpm_style_learning_missed/benchmark/resources/datasets/neurips-2023-data-subsample/op3_emb_<X>.pkl
...
# results folder:
#   data_lpm_style_learning_missed/benchmark/results/methods/<pipeline>_<X>/stability/predictions_seed_*.h5ad
#
# Usage:
#   ./run_new_split_stability_fp_lpm_learning_missed.sh                      # sweep default EPOCHS
#   ./run_new_split_stability_fp_lpm_learning_missed.sh 5 10 15              # sweep just these
# ============================================================================
...
RUNNER=./run_pipelines/run_nn_retraining_with_pseudolabels_mol_emb_learning_missed_stability.sh
